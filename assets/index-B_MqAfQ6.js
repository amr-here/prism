...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function so(){return new Sn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:va(),fragmentShader:`
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function ro(){return new Sn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:va(),fragmentShader:`
...
#define LOW_PRECISION`),t}function tp(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Yo?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===qo?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===sn&&(t="SHADOWMAP_TYPE_VSM"),t}function ep(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ui:case di:t="ENVMAP_TYPE_CUBE";break;case Is:t="ENVMAP_TYPE_CUBE_UV";break}return t}function np(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case di:t="ENVMAP_MODE_REFRACTION";break}return t}function ip(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case la:t="ENVMAP_BLENDING_MULTIPLY";break;case rc:t="ENVMAP_BLENDING_MIX";break;case ac:t="ENVMAP_BLENDING_ADD";break}return t}function sp(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function rp(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=tp(e),l=ep(e),h=np(e),d=ip(e),f=sp(e),m=Yf(e),_=qf(r),v=s.createProgram();let p,u,E=e.glslVersion?"#version "+e.glslVersion+`
...
}`;function pm(i){const t=document.createElement("style");t.innerHTML=i;const e=document.querySelector("head link[rel=stylesheet], head style");e?document.head.insertBefore(t,e):document.head.appendChild(t)}let Xo=!1;class Ma{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:s,title:r="Controls",closeFolders:a=!1,injectStyles:o=!0,touchStyles:c=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",l=>{(l.code==="Enter"||l.code==="Space")&&(l.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(r),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),c&&this.domElement.classList.add("allow-touch-styles"),!Xo&&o&&(pm(fm),Xo=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),s&&this.domElement.style.setProperty("--width",s+"px"),this._closeFolders=a}add(t,e,n,s,r){if(Object(n)===n)return new um(this,t,e,n);const a=t[e];switch(typeof a){case"number":return new hm(this,t,e,n,s,r);case"boolean":return new im(this,t,e);case"string":return new dm(this,t,e);case"function":return new Er(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new cm(this,t,e,n)}addFolder(t){const e=new Ma({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof Er||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof Er)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const s=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}const bs=new Ma,Tl=document.querySelector("canvas.webgl"),xe=new Bp,mm=new nm;let Pn=null;const re={color:"#fff",metalness:1,roughness:.51,envMapIntensity:.9,clearcoat:1,transparent:!0,transmission:.95,opacity:.5,reflectivity:.2,ior:.9,side:Ie};mm.load("/models/prism.obj",function(i){Pn=i,i.traverse(n=>{n.isMesh&&(n.castShadow=!0,n.material=new zp({color:re.color,metalness:re.metalness,roughness:re.roughness,envMapIntensity:re.envMapIntensity,clearcoat:re.clearcoat,transparent:re.transparent,opacity:re.opacity,reflectivity:re.reflectivity,ior:re.ior,side:re.side}))}),xe.add(Pn),Pn.position.y=-1.8,Pn.position.x=-1.14,Pn.scale.set(.324,.324,.324),bs.add(Pn.position,"x").min(-5).max(5).step(.001).name("Position X"),bs.add(Pn.position,"y").min(-5).max(-1.8).step(.001).name("Position Y");const t=bs.addFolder("Material Params");t.addColor(re,"color").name("Color").onChange(n=>{i.traverse(s=>{s.isMesh&&s.material.color.set(n)})}),t.add(re,"metalness").min(0).max(2).step(.001).name("Metalness").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.metalness=n)})}),t.add(re,"roughness").min(0).max(1).step(.001).name("Roughness").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.roughness=n)})}),t.add(re,"envMapIntensity").min(0).max(2).step(.001).name("EnvMap Intensity").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.envMapIntensity=n)})}),t.add(re,"clearcoat").min(0).max(1).step(.001).name("Clearcoat").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.clearcoat=n)})}),t.add(re,"transparent").name("Transparent").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.transparent=n)})}),t.add(re,"opacity").min(0).max(1).step(.001).name("Opacity").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.opacity=n)})}),t.add(re,"reflectivity").min(0).max(1).step(.001).name("Reflectivity").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.reflectivity=n)})}),t.add(re,"ior").min(0).max(2).step(.001).name("IOR").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.ior=n)})});const e={FrontSide:on,BackSide:Se,DoubleSide:Ie};t.add(re,"side",e).name("Side").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.side=n)})})},function(i){console.log(i.loaded/i.total*100+"% loaded")},function(i){console.error("An error happened",i)});const Sa=new Ne(new Bi(10,10),new Al({color:"#444444",metalness:0,roughness:.5,side:Ie}));Sa.receiveShadow=!0;Sa.rotation.x=-Math.PI*.5;xe.add(Sa);const zi=new vi("rgb(0,0,81)",1.8);zi.position.set(5,5,5);zi.castShadow=!0;xe.add(zi);const gm=new xi(zi);xe.add(gm);const Os=new vi("rgb(0,0,81)",5);Os.position.set(-2,1,-4);xe.add(Os);const _m=new xi(Os);xe.add(_m);const Bs=new vi("rgb(255,255,255)",2);Bs.position.set(0,-5,-3);xe.add(Bs);const vm=new xi(Bs);xe.add(vm);const zs=new vi("rgb(0,0,81)",.5);zs.position.set(6,2,-3);xe.add(zs);const xm=new xi(zs);xe.add(xm);const Hs=new vi("rgb(0,0,81)",.1);Hs.position.set(-3,2,5);xe.add(Hs);const Mm=new xi(Hs);xe.add(Mm);const Vs=new vi("rgb(0,0,81)",.1);Vs.position.set(-7,6,5);xe.add(Vs);const Sm=new xi(Vs);xe.add(Sm);const ym=[{light:zi,name:"Directional Light 1"},{light:Os,name:"Directional Light 2"},{light:Bs,name:"Directional Light 3"},{light:zs,name:"Directional Light 4"},{light:Hs,name:"Directional Light 5"},{light:Vs,name:"Directional Light 6"}];ym.forEach(i=>{const t=bs.addFolder(i.name);t.add(i.light,"intensity",0,10,.1).name("Intensity"),t.add(i.light.position,"x",-20,20,.1).name("Position X"),t.add(i.light.position,"y",-20,20,.1).name("Position Y"),t.add(i.light.position,"z",-20,20,.1).name("Position Z"),t.addColor(i.light,"color").name("Color")});const Xe={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{Xe.width=window.innerWidth,Xe.height=window.innerHeight,gi.aspect=Xe.width/Xe.height,gi.updateProjectionMatrix(),zn.setSize(Xe.width,Xe.height),zn.setPixelRatio(Math.min(window.devicePixelRatio,2))});const gi=new De(75,Xe.width/Xe.height,.1,100);gi.position.set(2,2,3.5);xe.add(gi);const ya=new Kp(gi,Tl);ya.target.set(0,.75,0);ya.enableDamping=!0;const zn=new Op({canvas:Tl});zn.shadowMap.enabled=!0;zn.shadowMap.type=qo;zn.setSize(Xe.width,Xe.height);zn.setPixelRatio(Math.min(window.devicePixelRatio,2));const Em=new $p,wl=()=>{Em.getElapsedTime(),ya.update(),zn.render(xe,gi),window.requestAnimationFrame(wl)};wl();
//# sourceMappingURL=index-B_MqAfQ6.js.map
