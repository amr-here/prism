...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vn,depthTest:!1,depthWrite:!1})}function fo(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ma(),fragmentShader:`
		...
		`,blending:vn,depthTest:!1,depthWrite:!1})}function po(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ma(),fragmentShader:`
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	...
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new _m(this,t,e,n)}addFolder(t){const e=new ya({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof br||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof br)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const s=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}const Os=new ya,Ul=document.querySelector("canvas.webgl"),Bi=new Yp,Em=new hm;let Ti=null;const Yt={color:"#fff",metalness:1,roughness:.51,envMapIntensity:.9,clearcoat:1,transparent:!0,transmission:.95,opacity:.5,reflectivity:.2,ior:.9,side:De,showHelpers:!1,paused:!1};Em.load("/prism/models/prism.obj",function(i){Ti=i,i.traverse(n=>{n.isMesh&&(n.castShadow=!0,n.material=new qp({color:Yt.color,metalness:Yt.metalness,roughness:Yt.roughness,envMapIntensity:Yt.envMapIntensity,clearcoat:Yt.clearcoat,transparent:Yt.transparent,opacity:Yt.opacity,reflectivity:Yt.reflectivity,ior:Yt.ior,side:Yt.side}))}),Bi.add(Ti),Ti.position.y=-1.8,Ti.position.x=-1.14,Ti.scale.set(.324,.324,.324);const t=Os.addFolder("Material Params");t.addColor(Yt,"color").name("Color").onChange(n=>{i.traverse(s=>{s.isMesh&&s.material.color.set(n)})}),t.add(Yt,"metalness").min(0).max(2).step(.001).name("Metalness").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.metalness=n)})}),t.add(Yt,"roughness").min(0).max(1).step(.001).name("Roughness").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.roughness=n)})}),t.add(Yt,"envMapIntensity").min(0).max(2).step(.001).name("EnvMap Intensity").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.envMapIntensity=n)})}),t.add(Yt,"clearcoat").min(0).max(1).step(.001).name("Clearcoat").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.clearcoat=n)})}),t.add(Yt,"transparent").name("Transparent").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.transparent=n)})}),t.add(Yt,"opacity").min(0).max(1).step(.001).name("Opacity").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.opacity=n)})}),t.add(Yt,"reflectivity").min(0).max(1).step(.001).name("Reflectivity").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.reflectivity=n)})}),t.add(Yt,"ior").min(0).max(2).step(.001).name("IOR").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.ior=n)})});const e={FrontSide:an,BackSide:Me,DoubleSide:De};t.add(Yt,"side",e).name("Side").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.side=n)})})},function(i){console.log(i.loaded/i.total*100+"% loaded")},function(i){console.error("An error happened",i)});const Nl=new Ue(new Oi(10,10),new Il({color:"#444444",metalness:0,roughness:.5,side:De}));Nl.receiveShadow=!0;Nl.rotation.x=-Math.PI*.5;const Ds=new ai;Bi.add(Ds);const zi=new _i("rgb(0,0,81)",1.8);zi.position.set(5,5,5);zi.castShadow=!0;const Ea=new vi(zi);Ea.visible=Yt.showHelpers;const Bs=new _i("rgb(0,0,81)",5);Bs.position.set(-2,1,-4);const ba=new vi(Bs);ba.visible=Yt.showHelpers;const zs=new _i("rgb(255,255,255)",2);zs.position.set(0,-5,-3);const Aa=new vi(zs);Bi.add(zs,Aa);Aa.visible=Yt.showHelpers;const Hs=new _i("rgb(0,0,81)",.5);Hs.position.set(6,2,-3);const Ta=new vi(Hs);Ta.visible=Yt.showHelpers;const Vs=new _i("rgb(0,0,81)",.1);Vs.position.set(-3,2,5);const wa=new vi(Vs);wa.visible=Yt.showHelpers;const ks=new _i("rgb(0,0,81)",.1);ks.position.set(-7,6,5);const Ca=new vi(ks);Ca.visible=Yt.showHelpers;Ds.add(zi,Bs,Hs,Vs,ks,Ea,ba,Ta,wa,Ca);const bm=[{light:zi,name:"Directional Light 1"},{light:Bs,name:"Directional Light 2"},{light:zs,name:"Directional Light 3"},{light:Hs,name:"Directional Light 4"},{light:Vs,name:"Directional Light 5"},{light:ks,name:"Directional Light 6"}];Os.add(Yt,"paused").name("Pause Animation").onChange(i=>{i||Pa()});const Am=[Ea,ba,Aa,Ta,wa,Ca];Os.add(Yt,"showHelpers").name("Show Helpers").onChange(i=>{Am.forEach(t=>{t.visible=i})});bm.forEach(i=>{const t=Os.addFolder(i.name);t.add(i.light,"intensity",0,10,.1).name("Intensity"),t.add(i.light.position,"x",-20,20,.1).name("Position X"),t.add(i.light.position,"y",-20,20,.1).name("Position Y"),t.add(i.light.position,"z",-20,20,.1).name("Position Z"),t.addColor(i.light,"color").name("Color")});const We={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{We.width=window.innerWidth,We.height=window.innerHeight,mi.aspect=We.width/We.height,mi.updateProjectionMatrix(),On.setSize(We.width,We.height),On.setPixelRatio(Math.min(window.devicePixelRatio,2))});const mi=new Le(75,We.width/We.height,.1,100);mi.position.set(2,2,3.5);Bi.add(mi);const Ra=new sm(mi,Ul);Ra.target.set(0,.75,0);Ra.enableDamping=!0;const On=new Xp({canvas:Ul});On.shadowMap.enabled=!0;On.shadowMap.type=el;On.setSize(We.width,We.height);On.setPixelRatio(Math.min(window.devicePixelRatio,2));const Tm=new nm;let Ar=0;const Pa=()=>{const i=Tm.getDelta();Yt.paused||(Ar+=i),Ds.rotation.x=Ar*.01*(Math.PI*2),Ds.rotation.y=Ar*.1*(Math.PI*2),Ra.update(),On.render(Bi,mi),window.requestAnimationFrame(Pa)};Pa();
//# sourceMappingURL=index-DGDrrq9l.js.map
