...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function so(){return new Sn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:xa(),fragmentShader:`
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function ro(){return new Sn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xa(),fragmentShader:`
...
#define LOW_PRECISION`),t}function ep(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Yo?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===qo?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===sn&&(t="SHADOWMAP_TYPE_VSM"),t}function np(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case di:case fi:t="ENVMAP_TYPE_CUBE";break;case zs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function ip(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case fi:t="ENVMAP_MODE_REFRACTION";break}return t}function sp(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ca:t="ENVMAP_BLENDING_MULTIPLY";break;case ac:t="ENVMAP_BLENDING_MIX";break;case oc:t="ENVMAP_BLENDING_ADD";break}return t}function rp(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function ap(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=ep(e),l=np(e),h=ip(e),d=sp(e),f=rp(e),m=qf(e),_=$f(r),v=s.createProgram();let p,u,E=e.glslVersion?"#version "+e.glslVersion+`
...
}`;function mm(i){const t=document.createElement("style");t.innerHTML=i;const e=document.querySelector("head link[rel=stylesheet], head style");e?document.head.insertBefore(t,e):document.head.appendChild(t)}let Xo=!1;class Sa{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:s,title:r="Controls",closeFolders:a=!1,injectStyles:o=!0,touchStyles:c=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",l=>{(l.code==="Enter"||l.code==="Space")&&(l.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(r),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),c&&this.domElement.classList.add("allow-touch-styles"),!Xo&&o&&(mm(pm),Xo=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),s&&this.domElement.style.setProperty("--width",s+"px"),this._closeFolders=a}add(t,e,n,s,r){if(Object(n)===n)return new dm(this,t,e,n);const a=t[e];switch(typeof a){case"number":return new um(this,t,e,n,s,r);case"boolean":return new sm(this,t,e);case"string":return new fm(this,t,e);case"function":return new br(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new hm(this,t,e,n)}addFolder(t){const e=new Sa({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof br||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof br)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const s=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}const Rs=new Sa,Tl=document.querySelector("canvas.webgl"),je=new zp,gm=new im;let Pn=null;const re={color:"#fff",metalness:1,roughness:.51,envMapIntensity:.9,clearcoat:1,transparent:!0,transmission:.95,opacity:.5,reflectivity:.2,ior:.9,side:De};gm.load("/prism/models/prism.obj",function(i){Pn=i,i.traverse(n=>{n.isMesh&&(n.castShadow=!0,n.material=new Hp({color:re.color,metalness:re.metalness,roughness:re.roughness,envMapIntensity:re.envMapIntensity,clearcoat:re.clearcoat,transparent:re.transparent,opacity:re.opacity,reflectivity:re.reflectivity,ior:re.ior,side:re.side}))}),je.add(Pn),Pn.position.y=-1.8,Pn.position.x=-1.14,Pn.scale.set(.324,.324,.324),Rs.add(Pn.position,"x").min(-5).max(5).step(.001).name("Position X"),Rs.add(Pn.position,"y").min(-5).max(-1.8).step(.001).name("Position Y");const t=Rs.addFolder("Material Params");t.addColor(re,"color").name("Color").onChange(n=>{i.traverse(s=>{s.isMesh&&s.material.color.set(n)})}),t.add(re,"metalness").min(0).max(2).step(.001).name("Metalness").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.metalness=n)})}),t.add(re,"roughness").min(0).max(1).step(.001).name("Roughness").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.roughness=n)})}),t.add(re,"envMapIntensity").min(0).max(2).step(.001).name("EnvMap Intensity").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.envMapIntensity=n)})}),t.add(re,"clearcoat").min(0).max(1).step(.001).name("Clearcoat").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.clearcoat=n)})}),t.add(re,"transparent").name("Transparent").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.transparent=n)})}),t.add(re,"opacity").min(0).max(1).step(.001).name("Opacity").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.opacity=n)})}),t.add(re,"reflectivity").min(0).max(1).step(.001).name("Reflectivity").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.reflectivity=n)})}),t.add(re,"ior").min(0).max(2).step(.001).name("IOR").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.ior=n)})});const e={FrontSide:on,BackSide:Me,DoubleSide:De};t.add(re,"side",e).name("Side").onChange(n=>{i.traverse(s=>{s.isMesh&&(s.material.side=n)})})},function(i){console.log(i.loaded/i.total*100+"% loaded")},function(i){console.error("An error happened",i)});const wl=new Ue(new zi(10,10),new Al({color:"#444444",metalness:0,roughness:.5,side:De}));wl.receiveShadow=!0;wl.rotation.x=-Math.PI*.5;const Bs=new li;je.add(Bs);const Si=new xi("rgb(0,0,81)",1.8);Si.position.set(5,5,5);Si.castShadow=!0;je.add(Si);new Mi(Si);const Hi=new xi("rgb(0,0,81)",5);Hi.position.set(-2,1,-4);je.add(Hi);new Mi(Hi);const Vi=new xi("rgb(255,255,255)",2);Vi.position.set(0,-5,-3);je.add(Vi);new Mi(Vi);const ki=new xi("rgb(0,0,81)",.5);ki.position.set(6,2,-3);je.add(ki);new Mi(ki);const Gi=new xi("rgb(0,0,81)",.1);Gi.position.set(-3,2,5);je.add(Gi);new Mi(Gi);const Wi=new xi("rgb(0,0,81)",.1);Wi.position.set(-7,6,5);je.add(Wi);new Mi(Wi);Bs.add(Si,Hi,Vi,ki,Gi,Wi);const _m=[{light:Si,name:"Directional Light 1"},{light:Hi,name:"Directional Light 2"},{light:Vi,name:"Directional Light 3"},{light:ki,name:"Directional Light 4"},{light:Gi,name:"Directional Light 5"},{light:Wi,name:"Directional Light 6"}];_m.forEach(i=>{const t=Rs.addFolder(i.name);t.add(i.light,"intensity",0,10,.1).name("Intensity"),t.add(i.light.position,"x",-20,20,.1).name("Position X"),t.add(i.light.position,"y",-20,20,.1).name("Position Y"),t.add(i.light.position,"z",-20,20,.1).name("Position Z"),t.addColor(i.light,"color").name("Color")});const We={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{We.width=window.innerWidth,We.height=window.innerHeight,_i.aspect=We.width/We.height,_i.updateProjectionMatrix(),zn.setSize(We.width,We.height),zn.setPixelRatio(Math.min(window.devicePixelRatio,2))});const _i=new Le(75,We.width/We.height,.1,100);_i.position.set(2,2,3.5);je.add(_i);const ya=new Zp(_i,Tl);ya.target.set(0,.75,0);ya.enableDamping=!0;const zn=new Bp({canvas:Tl});zn.shadowMap.enabled=!0;zn.shadowMap.type=qo;zn.setSize(We.width,We.height);zn.setPixelRatio(Math.min(window.devicePixelRatio,2));const vm=new jp,Cl=()=>{const i=vm.getElapsedTime();Bs.rotation.y=Math.sin(i*.5)*.8,Bs.rotation.x=Math.cos(i*.1)*.2,ya.update(),zn.render(je,_i),window.requestAnimationFrame(Cl)};Cl();
//# sourceMappingURL=index-CQoDBhOO.js.map
